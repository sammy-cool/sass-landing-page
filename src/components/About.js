  ...
  const [sections] = React.useState([
    {
      ...
      text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi nulla, ducimus adipisci odit harum quidem debitis quos odio saepe cumque ex placeat numquam rem repellat tenetur iste? Nostrum, blanditiis mollitia?",
    },
    {
      id: 2,
      icon: (
      ...
      text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis reiciendis nisi magnam suscipit illo. Laboriosam ipsa doloribus quos odit quam tempora, accusantium molestiae iste dignissimos perspiciatis sint quas sit architecto.",
    },
    {
      id: 3,
      icon: (
      ...
      text: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aliquid eum voluptatum ut cum perspiciatis tempora ex expedita voluptates dolor omnis veritatis, esse quaerat autem modi, amet minus quibusdam possimus! Ullam?",
    },
  ]);
  return (
    <div className="about">
